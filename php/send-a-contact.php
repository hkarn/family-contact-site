<?php
  ...
  $reCAPTCHAkey_public = "KEY";
  $reCAPTCHAkey_secret = "KEY";
  $domain = "example.com";
  ...
  */
  ...
  if ($connection == true) {
    ...
    if ($result !== false && $result->num_rows > 25) {
  ...
  */
  ...
  if (!empty($_SESSION['formsenttime']) && $_SESSION['formsenttime'] > (time() - 30)) {
  ...
  if (!empty($_SESSION['from']) && $_SESSION['from'] !== $domain) {
